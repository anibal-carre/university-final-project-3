...
<head>
    ...
    <title>University | Maestro Profile</title>
</head>
        ...
        <div class="w-full flex flex-col">
            ...
            <div class="h-full pl-3">
                <div class="w-full flex items-center justify-between pr-3 mt-4 mb-5">
                    <h1 class="font-bold text-zinc-700 text-xl ">Maestro Profile</h1>
                    ...
                    <div class="w-80 h-auto bg-white rounded-sm sm:w-96">
                        ...
                        <div class="flex flex-col p-5 gap-5 text-center relative z-20">
                            ...
                            <div class="flex flex-col">
                                ...
                                <p class="self-start">José Ferreira</p>
                            </div>
                            ...
                            <a href="maestro_edit_profile.php" class="self-end">
                                <button
