        ...
        <div class="w-full flex flex-col">
            ...
            <div class="h-full pl-3">
                <div class="w-full flex items-center justify-between pr-3 mt-4 mb-5">
                    <h1 class="font-bold text-zinc-700 text-xl ">Alumno Edit Profile</h1>
                    <p class="font-semibold text-sm text-zinc-700"><span class="text-myblue">Home</span> / Profile
                    </p>
                </div>

                <div class="w-full">
                    <a href="alumno_profile.php">
                        <span class="material-symbols-outlined">
                            arrow_back
                        </span>
                    </a>
                ...
                <div class="w-full flex flex-row justify-center  mt-20">
                    <div class="w-80 h-auto bg-white rounded-sm sm:w-96">
                        ...
                        <div class="w-80 h-auto bg-white rounded-sm sm:w-96">
                            ...
                            <form action="alumno_profile.php" class="flex flex-col p-5 gap-5 text-center relative z-20">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="password" placeholder="Ingresa nueva contraseña" class="h-10 border border-zinc-300 bg-white rounded-sm px-3">
                                </div>
